...
import { A as AstroError, N as NoImageMetadata, e as FailedToFetchRemoteImageDimensions, R as RemoteImageNotAllowed, E as ExpectedImage, L as LocalImageUsedWrongly, M as MissingImageDimension, U as UnsupportedImageFormat, f as IncompatibleDescriptorOptions, g as UnsupportedImageConversion, h as InvalidImageService, i as ExpectedImageOptions, j as ExpectedNotESMImage } from './server_DjVGnHP9.mjs';
...
const baseService = {
  ...
  getURL(options, imageConfig) {
    ...
    const imageEndpoint = joinPaths("/GENERATIVE-COLLAPSE-DYNAMICS/", imageConfig.endpoint.route);
...
export { getConfiguredImageService as a, baseService as b, getImage as g, isESMImportedImage as i, parseQuality as p, resolveSrc as r };
