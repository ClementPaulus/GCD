...
import { p as renderElement, q as generateCspDigest, s as spreadAttributes, u as unescapeHTML, r as renderTemplate, A as AstroError, t as UnknownContentCollectionError, v as RenderUndefinedEntryError, w as createHeadAndContent, b as renderComponent } from './server_DjVGnHP9.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_EAHr2wCS.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_virtual_astro_get-image_BOyhzinm.mjs');
