...
pytest -v --tb=short                       # 19,397 tests
```
...
2. **Test** — Full pytest suite (19,397 tests, 218 test files)
...
**19,397 tests** across **218 test files**, organized by tier and domain:
...
├── tests/                     # 218 test files, 19,397 tests
