...
[![Tests: 18,841](https://img.shields.io/badge/tests-18%2C841-brightgreen.svg)](tests/)
...
Tier-1 (44 structural identities, 47 lemmas, 264 proven theorems) → Tier-0 (18,841 tests, 220 closure modules, C++17 accelerator) → Tier-2 (20 domains from particle physics to consciousness). One-way dependency. No back-edges within a frozen run.
...
pytest -v --tb=short                       # 18,841 tests
```
...
2. **Test** — Full pytest suite (18,841 tests, 213 test files)
...
**18,841 tests** across **213 test files**, organized by tier and domain:
...
├── tests/                     # 213 test files, 18,841 tests
