...
[![Tests: 17,639](https://img.shields.io/badge/tests-17%2C639-brightgreen.svg)](tests/)
...
Tier-1 (44 structural identities, 47 lemmas, 252 proven theorems) → Tier-0 (17,639 tests, 193 closure modules, C++17 accelerator) → Tier-2 (20 domains from particle physics to consciousness). One-way dependency. No back-edges within a frozen run.
...
pytest -v --tb=short                       # 17,639 tests
```
...
2. **Test** — Full pytest suite (17,639 tests, 202 test files)
...
**17,639 tests** across **202 test files**, organized by tier and domain:
...
├── tests/                     # 202 test files, 17,639 tests
