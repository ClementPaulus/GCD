...
[![Tests: 16,441](https://img.shields.io/badge/tests-16%2C441-brightgreen.svg)](tests/)
...
Tier-1 (44 structural identities, 47 lemmas, 252 proven theorems) → Tier-0 (16,441 tests, 193 closure modules, C++17 accelerator) → Tier-2 (20 domains from particle physics to consciousness). One-way dependency. No back-edges within a frozen run.
...
pytest -v --tb=short                       # 16,441 tests
```
...
2. **Test** — Full pytest suite (16,441 tests, 190 test files)
...
**16,441 tests** across **190 test files**, organized by tier and domain:
...
├── tests/                     # 190 test files, 16,441 tests
