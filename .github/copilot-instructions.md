...
**UMCP v2.1.4** · **5,240 tests** · **14 domains** · **120 closure modules** · **46 lemmas** · **37 dashboard pages**
...
**Version**: 2.1.4 · **Python**: ≥ 3.11 · **License**: MIT

## Architecture

```
src/umcp/
├── __init__.py               # Public API: validate(), MeasurementEngine, __version__ (v2.1.4)
