...
T001_ALLOWLIST_FILES = {
    ...
    "archive/reports/ACADEMIC_STATUS_REPORT.md",
    "archive/reports/NEGATIVE_RESULT_ANALYSIS.md",
    "archive/reports/PHILOSOPHICAL_CONVERGENCES.md",
    "CHANGELOG.md",
    "archive/reports/SYNTHESIS_REPORT.md",
    "archive/reports/CERN_HIGGS_RESEARCH.md",
    "README.md",
    "QUICKSTART_TUTORIAL.md",
    "archive/reports/SCALE_LADDER_REVELATIONS.md",
