import{c as d,F as S,R as g,D as b}from"./constants.DbPyemRV.js";import{c as B,a as C,v as T}from"./kernel.CZAlD7O0.js";const l=new Set(d.map(n=>n.id)),F={epistemology:{active:"bg-purple-700/50 border-purple-500 text-purple-200",idle:"hover:bg-purple-900/30"},ontology:{active:"bg-blue-700/50 border-blue-500 text-blue-200",idle:"hover:bg-blue-900/30"},phenomenology:{active:"bg-teal-700/50 border-teal-500 text-teal-200",idle:"hover:bg-teal-900/30"},history:{active:"bg-amber-700/50 border-amber-500 text-amber-200",idle:"hover:bg-amber-900/30"},policy:{active:"bg-red-700/50 border-red-500 text-red-200",idle:"hover:bg-red-900/30"},physics:{active:"bg-cyan-700/50 border-cyan-500 text-cyan-200",idle:"hover:bg-cyan-900/30"},finance:{active:"bg-green-700/50 border-green-500 text-green-200",idle:"hover:bg-green-900/30"},security:{active:"bg-orange-700/50 border-orange-500 text-orange-200",idle:"hover:bg-orange-900/30"},semiotics:{active:"bg-indigo-700/50 border-indigo-500 text-indigo-200",idle:"hover:bg-indigo-900/30"}},R=["amber","green","red","blue","purple"];function A(){const n=document.getElementById("word-cards");n.innerHTML=S.map((e,t)=>`
        <div class="bg-kernel-900 border border-kernel-700 rounded-lg p-4">
          <div class="flex items-center justify-between mb-2">
            <span class="text-${R[t]}-400 font-bold">${e.word}</span>
      ...
      </tr>`).join(""),n.querySelectorAll("tr[data-lens-row]").forEach(t=>{t.addEventListener("click",()=>v(t.dataset.lensRow))})}function H(){const n=document.getElementById("scenario-buttons");n.innerHTML=g.map((e,t)=>`<button data-scenario="${t}"
        ...
        ${s?"":'<div class="hidden md:flex items-center text-kernel-600 text-lg px-1">→</div>'}`}).join("")}document.getElementById("lens-all").addEventListener("click",()=>{d.forEach(n=>l.add(n.id)),a(),c()});document.getElementById("lens-none").addEventListener("click",()=>{l.clear(),a(),c()});A();a();c();H();M();
