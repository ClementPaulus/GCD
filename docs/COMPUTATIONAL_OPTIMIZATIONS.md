...
### OPT-3: Heterogeneity Gap for Heterogeneity Quantification (from Lemma 4, Lemma 34)
...
def compute_heterogeneity_gap(F, IC):
    gap = F - IC  # Always >= 0 by integrity bound
...
### OPT-15: Drift Calibration via Heterogeneity Gap (from Lemma 34)
