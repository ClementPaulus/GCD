...
\newcommand{\ValidatorLine}{v2.2.5}
...
under a single kernel, and summarize the 38 structural identities and 46 lemmas verified to machine precision.
\end{abstract}
...
% -------------------------
% Structural identities summary (44 identities; 46 lemmas)
% -------------------------
\section{Structural identities and lemma inventory}
\label{sec:identities}

The Tier-1 kernel and its Tier-0 protocol machinery yield 44 structural identities and 46 lemmas,
...
The 46 lemmas (Lemmas 1--42 plus extensions) cover: range bounds (L1), monotonicity (L2, L12), sensitivity control (L3, L7),
...
The \ValidatorLine\ release line contains 5{,}413 tests across 16 domain closures, 122 closure modules,
and 46 lemmas. The three core Tier-1 identities ($F+\omega=1$, $\IC\le F$, $\IC=\exp(\kappa)$) are verified with
zero violations across the full test suite. The 38 structural identities are re-derivable by running the diagnostic
