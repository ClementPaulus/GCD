...
47 lemmas, and 24+ theorems are derived independently.
...
Of particular note:
ten theorems~\cite{paulus2026sm} connect
...
The kernel specification contains 47 proven lemmas that
...
15 domains, 121 closures, all \conform{} &
...
cross-domain validation across 15 domains (Sec.~\ref{sec:universality}),
the five degenerate limits (Sec.~\ref{sec:degenerate}),
the 47-lemma foundation (Sec.~\ref{sec:lemmas}),
...
validated across 15 domains, and welded onto the frozen
...
\begin{enumerate}[nosep,leftmargin=*]
  ...
  \item The \textbf{47-lemma foundation}
