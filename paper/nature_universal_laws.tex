...
computational verification---15{,}014~automated proofs across
...
In total, 15{,}014~deterministic automated proofs span
20~domains (Table~\ref{tab:domains}), supported by
181~closure modules, 47~proven lemmas, and 44~structural
...
All 15{,}014~tests run under Python~3.12 with NumPy~1.26 using
